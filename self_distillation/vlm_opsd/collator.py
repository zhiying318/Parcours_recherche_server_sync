...
class VLMOPSDCollator:
    ...
    def __init__(self, processor, repo_root: str | Path, *,
                 student_thinking: bool = False, teacher_thinking: bool = False):
    ...
    def __call__(self, features: list[dict]):
        ...
        student = self._encode(student_conversations, self.student_thinking)
        teacher = self._encode(teacher_conversations, self.teacher_thinking)
