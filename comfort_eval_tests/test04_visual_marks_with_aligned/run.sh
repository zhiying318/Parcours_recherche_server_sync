...
CUDA_VISIBLE_DEVICES=1 python -m spatial_eval.cli \
  ...
  --out_csv "$RESULTS_DIR/mcq_short_qwen3vl_with_aligned.csv" \
  --ask_mode mcq \
  --answer_length short \
...
CUDA_VISIBLE_DEVICES=1 python -m spatial_eval.cli \
  ...
  --model_id Qwen/Qwen3-VL-8B-Instruct \
  --image_json "$IMAGES_JSON" \
  --out_csv "$RESULTS_DIR/mcq_middle_qwen3vl_with_aligned.csv" \
  --ask_mode mcq \
...
CUDA_VISIBLE_DEVICES=1 python -m spatial_eval.cli \
  ...
  --image_json "$IMAGES_JSON" \
  --out_csv "$RESULTS_DIR/mcq_short_internvl_with_aligned.csv" \
  --ask_mode mcq \
  --answer_length short \
  --mcq_prompt_note "The arrows in the image indicate the person's face orientation." \
  --mcq_seed 123
...
CUDA_VISIBLE_DEVICES=1 python -m spatial_eval.cli \
  ...
  --model_id OpenGVLab/InternVL3_5-8B-HF \
  --image_json "$IMAGES_JSON" \
  --out_csv "$RESULTS_DIR/mcq_middle_internvl_with_aligned.csv" \
  --ask_mode mcq \
  --answer_length middle \
  --mcq_prompt_note "The arrows in the image indicate the person's face orientation." \
  --mcq_seed 123
...
CUDA_VISIBLE_DEVICES=1 python -m spatial_eval.cli \
  ...
  --image_json "$IMAGES_JSON" \
  --out_csv "$RESULTS_DIR/mcq_short_qwen3_5vl_with_aligned.csv" \
  --ask_mode mcq \
  --answer_length short \
  --mcq_prompt_note "The arrows in the image indicate the person's face orientation." \
  --mcq_seed 123
...
CUDA_VISIBLE_DEVICES=1 python -m spatial_eval.cli \
  ...
  --model_id Qwen/Qwen3.5-9B \
  --image_json "$IMAGES_JSON" \
  --out_csv "$RESULTS_DIR/mcq_middle_qwen3_5vl_with_aligned.csv" \
  --ask_mode mcq \
  --answer_length middle \
  --mcq_prompt_note "The arrows in the image indicate the person's face orientation." \
  --mcq_seed 123
